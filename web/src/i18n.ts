...
const messages = {
  en: {
    ...
    'tl.view.cast':         'CASTS',
    'tl.view.showCast':     'Show boss casts',
    'tl.view.hideCast':     'Hide boss casts',
    ...
    'tl.orient':            'AXIS',
    'tl.orient.horizontal': 'HORIZONTAL',
    ...
    'mech.cat.cast':        'BOSS CAST',
    'mech.cat.cast.help':   'A boss cast (FFLogs "casts" tab) — no damage type, not mitigated',
  ...
  fr: {
    ...
    'tl.view.cast':         'SORTS',
    'tl.view.showCast':     'Afficher les sorts du boss',
    'tl.view.hideCast':     'Cacher les sorts du boss',
    'tl.view.compact':      'COMPACT',
    ...
    'mech.cat.cast':        'SORT BOSS',
    'mech.cat.cast.help':   'Un sort du boss (onglet « sorts » FFLogs) — pas de type de dégâts, non mité',
